    ...
    <section id="localizacao" className="scroll-mt-[72px]">
      <div className="w-full max-w-6xl mx-auto bg-[#e8edf5] pt-20 pb-20 px-8">
        ...
        <div className="flex flex-row gap-6">
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Nosso endereço</h3>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors shadow-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-violet-800 hover:bg-violet-700 rounded-lg text-sm font-medium text-white transition-colors shadow-sm"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Google Maps */}
          <div className="flex-1 rounded-xl overflow-hidden shadow-sm min-h-[300px]">
